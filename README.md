...
- `src/Components/Journey/createJourneyScene.js`: original geometry for the
  bus, scooter, rider, stylized campuses, trees, road, and skyline. No Blender
...
rather than running a continuous animation loop. Reduced-motion preferences,
short landscape screens, and WebGL failures use a compact illustrated journey.
